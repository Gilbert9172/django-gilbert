...
SECRET_KEY = 'f7&yt0*_a%&sf$9ep!kqomy*4x(_03=*+=^sgi_)1tfwp#!7+#'
...
ROOT_URLCONF = 'gilbert.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'gilbert', 'templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'gilbert.wsgi.application'
